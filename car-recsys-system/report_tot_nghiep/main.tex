...
%% PREAMBLE
% --- Font 12pt theo template; oneside để nộp PDF / in 1 mặt (không trang trắng).
...
% oneside: tên chương/section ở trái, số trang (đậm) ở phải — như template.
\fancyhead[L]{\bfseries\nouppercase{\rightmark}} % "1.1 Tên section"
...
\chapter{KIẾN TRÚC HỆ THỐNG, BACKEND VÀ HỆ THỐNG ĐỀ XUẤT}
\input{chapters/backend}
