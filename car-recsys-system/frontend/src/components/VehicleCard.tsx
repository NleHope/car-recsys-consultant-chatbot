    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-3 pt-3 border-t border-border/40">
          {vehicle.mileage_str && (
            <>
              <div className="flex items-center gap-1.5 text-xs text-[#A87601]/80">
                <Gauge className="h-3.5 w-3.5 text-[#A87601]/70" />
                <span className="truncate">{vehicle.mileage_str}</span>
              </div>
              <div className="w-px h-3 bg-border/50" />
            </>
          ...
          {vehicle.fuel_type && (
            <>
              <div className="flex items-center gap-1.5 text-xs text-[#A87601]/80">
                <Fuel className="h-3.5 w-3.5 text-[#A87601]/70" />
                <span className="truncate">{vehicle.fuel_type}</span>
              </div>
              <div className="w-px h-3 bg-border/50" />
            </>
          ...
          {vehicle.transmission && (
            <div className="flex items-center gap-1.5 text-xs text-[#A87601]/80">
              <Settings2 className="h-3.5 w-3.5 text-[#A87601]/70" />
              <span className="truncate">{vehicle.transmission.split(' ')[0]}</span>
            </div>
          )}
        </div>
